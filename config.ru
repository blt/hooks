require './application'
Hooks::Application.initialize!

# Development middlewares
if Hooks::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => Hooks::Application.root(:public)
end
